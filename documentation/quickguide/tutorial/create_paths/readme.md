...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-1.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-2.png" width="512" height="360"> <br><br>
    </td>
  ...
  <tr>
    <td> <img src="quickguide/tutorial/images/create-path-3.png" width="512" height="360">
    </td>
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-4.png" width="512" height="360"> </td>
    <td> Double-click on the <i>Data Manager</i> <b>Paths / aorta</b> <i>Data Node</i> with the left mouse button to bring 
         ...
         <ul style="list-style-type:none;">
             <li> <img src="quickguide/tutorial/images/path-add-button.png" width="62" height="15"> - Add a <i>Path</i> point 
                  at the current crosshairs location. <br><br>
             </li>
             <li> <img src="quickguide/tutorial/images/path-del-button.png" width="62" height="15"> - Delete the currently 
...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-5.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-6.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-7.png" width="512" height="360"></td>
    <td> 
    Create several more <i>Path</i> points using the left mouse button to move the crosshairs in the 2D views and 
         ...
         Press the <img src="quickguide/gui/images/gui-save-icon.png" width="20" height="17"> icon in the
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-8.png" width="512" height="360"> </td>
    <td> 
...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-9.png" width="512" height="360"> </td>
    <td> Select the <i>Paths</i> <i>Tool</i> in the <i>Data Manager</i> with the right mouse button. <br><br>
         Select the <b>Create Path</b> menu option.
    </td>
  </tr>
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-10.png" width="512" height="360"> <br><br>
    </td>
    <td> A <b>Create New Path</b> <i>DiaglogBox</i> appears. <br><br>
  ...
  <tr>
    <td> <img src="quickguide/tutorial/images/create-path-11.png" width="512" height="360">
    </td>
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-12.png" width="512" height="360"> </td>
...
<table class="table table-bordered" style="width:100%">
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-13.png" width="512" height="360"> </td>
  ...
  <tr>
    <td><img src="quickguide/tutorial/images/create-path-14.png" width="512" height="360"> </td>
